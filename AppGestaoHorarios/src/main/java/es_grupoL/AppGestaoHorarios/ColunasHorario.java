...
public enum ColunasHorario {
	Curso("Curso"), UnidadeCurricular("Unidade Curricular"), Turno("Turno"), Turma("Turma"), InscritosNoTurno("Inscritos no turno"), 
	DiaDaSemana("Dia da semana"), HoraInicioDaAula("Hora início da aula"), HoraFimDaAula("Hora fim da aula"), 
	DataDaAula("Data da aula"), CaracteristicasDaSalaPedidaParaAAula("Características da sala pedida para a aula"), 
