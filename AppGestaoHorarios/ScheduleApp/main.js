...
const table = new Tabulator("#example-table", {
    ...
    columns: [
		...
		{ title: "Unidade Curricular", field: "UnidadeCurricular", headerFilter: "input" },
		{ title: "Turno", field: "Turno", headerFilter: "input" },
		{ title: "Turma", field: "Turma", headerFilter: "input" },
		{ title: "Inscritos no turno", field: "InscritosNoTurno", headerFilter: "input" },
		{ title: "Dia da semana", field: "DiaDaSemana", headerFilter: "input" },
		{ title: "Hora início da aula", field: "HoraInicioDaAula", headerFilter: "input" },
		{ title: "Hora fim da aula", field: "HoraFimDaAula", headerFilter: "input" },
		{ title: "Data da aula", field: "DataDaAula", headerFilter: "input" },
		{ title: "Características da sala pedida para a aula", field: "CaracteristicasDaSalaPedidaParaAAula", headerFilter: "input" },
		{ title: "Sala atribuída à aula", field: "SalaAtribuidaAAula", headerFilter: "input" },
	],
